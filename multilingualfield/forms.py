...
class MultiLingualFileFieldForm(MultiValueField):
    ...
    def widget_attrs(self, widget):
        ...
        to the Widget, based on this Field.
        """
        return {'maxlength':self.individual_widget_max_length} if self.individual_widget_max_length else {}
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mandatory_field = kwargs['required']
        fields = [
            FileOrAlreadyExistantFilePathField(label=language_verbose, max_length=self.individual_widget_max_length)
            for language_code, language_verbose in LANGUAGES
        ]
